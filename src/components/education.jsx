      ...
      <div className='education'>
        ...
        <div className='ed_experience'>
          <div className='ed_school'>
            <img src="https://city.apps01.yorku.ca/wp-content/uploads/2013/02/yorkusmallogo1.jpg" alt="profile" height='250px' width="180px"></img>
          ...
          <div className='ed_school'>
            <img src="https://s3.amazonaws.com/f6s-public/profiles/673293_original.jpg" alt="profile" height='270px' width="250px"></img>
            <div className='school'>
